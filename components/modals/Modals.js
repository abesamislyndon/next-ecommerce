      ...
      <div className=" bg-white p-6 rounded-lg shadow-lg lg:w-[30%]">
        ...
        <div className="pt-20 pb-20 pl-1 pr-1">
          <div className="grid grid-cols-2 gap-5">
            <button
              className="block w-full p-2  mb-2 text-center text-xl bg-white text-dark border rounded-md"
              onClick={onClose}
            >
              Order as Guest
            </button>
            ...
            <button
              className="block w-full p-2 mb-2 text-center text-xl bg-white text-dark border border-black-100 rounded-md"
              onClick={onRegister}
            >
              Register
            </button>
