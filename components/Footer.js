...
export default function Footer() {
  return (
    <>
      <footer className="bg-white dark:bg-[#cc0404] mt-auto">
        <div className="w-full mx-auto container  p-4 py-6 ">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="/" className="flex items-center">
                <Image className="h-4 w-auto" src={ent3logoWhite} />
              </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                ...
                <ul className="text-[#fc9595] font-light text-xs">
                  <li className="mb-4">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a
                href="#"
                className="text-[#fc9595] hover:text-gray-900 dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
